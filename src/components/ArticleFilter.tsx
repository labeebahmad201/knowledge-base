...
const articles: Article[] = [
  ...
  {title: 'Building Public APIs for Modules Using Interfaces', path: '/docs/software-engineering/module-public-api-interface', category: 'Architecture'},
  ...
  {title: 'JavaScript / TypeScript Interview Questions', path: '/docs/software-engineering/js-ts-questions', category: 'Engineering'},
  ...
  {title: 'Language Choice: How to Pick the Right Language for the Job', path: '/docs/software-engineering/language-choice', category: 'Engineering'},
  ...
  {title: 'Software Development Stories', path: '/docs/software-engineering/development-stories', category: 'Engineering'},
